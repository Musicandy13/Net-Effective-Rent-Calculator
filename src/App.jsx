...
const BASE_H = 15; // X-Achsenhöhe (Bars & Waterfall)
...
function NumericField({
  ...
  const num = P(value);
  const show =
    focus ? value : format === "int" ? F(num, 0) : format === "1dec" ? F(num, 1) : F(num, 2);
  return (
          ...
          <div className="md:sticky md:top-6 h-fit">
            <div className="rounded-lg border p-4 space-y-2 bg-white">
              ...
              <div ref={resultsContentRef}>
                ...
                <p className="mb-1">
                  <strong className="text-lg">Headline Rent:</strong>{" "}
                  <strong>
                    {F(rent, 2)} €/sqm
                  </strong>
                </p>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart
                        ...
                        margin={{
                          top: 8,
                          right: 0,
                          bottom: Math.max(0, BASE_B + FIT_EXTRA),
                          left: 0,
                        }}
                      >
                        <XAxis
