...
const BASE_H = -150;    // X-Achsenhöhe (Bars & Waterfall) – vorher 30, jetzt +5
const BASE_B = -150;    // bottom margin (Bars & Waterfall) – vorher 28, jetzt +5
const FIT_EXTRA = -150; // Fit-Outs zusätzlich tiefer als Bars/Waterfall (0 = gleiche Linie)
/* --------------------------------------------------------------------- */
